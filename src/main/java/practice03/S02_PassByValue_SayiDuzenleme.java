...
public class S02_PassByValue_SayiDuzenleme {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        sayi=karesiniAl(sayi);//bu kutunun içine koyabilmek için void int yaptık methodda
                              //kutuya koyarsak methodta return yazmamız gerek ve soutu mainde yapıyoruz
        System.out.println(sayi);
